package com.example.dragoon.attendence;
...
public class AttendActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean hasPermission = (ContextCompat.checkSelfPermission(AttendActivity.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED);
        boolean hasPermission1 = (ContextCompat.checkSelfPermission(AttendActivity.this,
